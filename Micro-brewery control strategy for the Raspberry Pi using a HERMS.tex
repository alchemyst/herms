...
{\Large \bf Heerden Process Engineering \\ South Africa \\ Version 0.2 \\ 2015 \\}
\end{center}
\vfill
% Open to suggestions on contribution and acknowledgment
\clearpage
...
Find the latest version of the document at \url{heerden.co.za}. % Website to be updated as soon as revision 1.0 is reached.
...
This chapter will give a general description of the brewing processes. It involves three systems. The sugar extraction, fermentation and an auxiliary system.  
...
\label{fig:main_pid}
\end{figure}
% A bypass valve (01CV004) has been placed over 01CV008 on the main P&ID, because the solenoid valves act as check valves. The control philosophy diagrams still needs to be updated.

The third vessel used is the \acf{KET}. It is used to preheat the water for mashing and finally to boil the wort. The hops is also added in this vessel.
...
After the wort is prepared and cooled, it is transferred to a the \acf{FER} situated inside a refrigeration unit. This controls the temperature of the fermentation process.

\section{Auxiliaries}

The auxiliary system consists of milling process a that supports the sugar extraction process. The system is represented by the diagram in Figure \ref{fig:aux_pid}.
...
In the next chapter, the complete control philosophy will be given for the \ac{HERMS}, fermentation process and a \acf{CIP} process.
...
Equipment cost estimate to be provided in next minor revision.
